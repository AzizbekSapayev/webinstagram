...
<head>
    ...
    <style>
        ...
        .posts {
    display: flex;
    flex-direction: column; /* Vertikal yo'nalish */
    gap: 20px; /* Har bir post orasida bo'shliq */
    align-items: center; /* Markazlashgan joylashuv */
    padding: 20px;
}

.post {
    width: 40%; /* Kattaroq kenglik */
...
.post img, .post video {
    width: 100%; /* Videoning kengligi postga teng */
    height: auto; /* Aspekt nisbatini saqlash */
    border-radius: 10px;
}
        .post-text {
            margin-top: 10px;
        ...
        .popup-content {
    max-width: 80%; /* Pop-up kengligini oshirish */
    max-height: 80%; /* Pop-up balandligini oshirish */
}

.popup img, .popup video {
    max-width: 100%; /* Popup ichidagi video kengligi */
    max-height: 100%; /* Popup ichidagi video balandligi */
}
